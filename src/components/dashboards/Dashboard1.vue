                ...
                <b-card-body>
                  <div class="rounded ui-bordered p-3 mb-3">
                    ...
                    <div class="media align-items-center mt-3">
                      <img :src="`${publicUrl}img/avatars/12-small.png`" class="d-block ui-w-30 rounded-circle" alt>
                  ...
                  <div class="rounded ui-bordered p-3 mb-3">
                    ...
                    <div class="media align-items-center mt-3">
                      <img :src="`${publicUrl}img/avatars/11-small.png`" class="d-block ui-w-30 rounded-circle" alt>
                  ...
                  <div class="rounded ui-bordered p-3">
                    ...
                    <div class="media align-items-center mt-3">
                      <img :src="`${publicUrl}img/avatars/10-small.png`" class="d-block ui-w-30 rounded-circle" alt>
