<template>
  <div>
      ...
      <div v-dragula bag="first-bag" class="col">
        ...
        <div class="dragula-example card card-condenced">
          <div class="card-body">
            ...
            <img :src="`${publicUrl}img/bg/4.jpg`" alt="" class="w-100 my-3">
    ...
    <draggable v-model="items" v-bind="{animation: 150}" tag="ul" class="sortable-example mb-5">
      <li v-for="item in items" :key="item" class="bg-light">{{ item }}</li>
    </draggable>

    <draggable v-model="items" v-bind="{animation: 150}" tag="ul" class="sortable-example sortable-example-inline mb-5">
      <li v-for="item in items" :key="item" class="bg-light">{{ item }}</li>
    </draggable>

    <draggable v-model="imageUrls" v-bind="{animation: 150}" class="sortable-example-3 mb-5 clearfix">
