  ...
  <div>
      ...
      <b-card no-body class="col-12 d-none d-md-block">
        ...
        <b-card-header class="row no-gutters align-items-center">
          ...
          <div class="col-3 cent"> کد هش</div>
        ...
        <div v-for="section in requests" :key="section.title">
          <b-card-body v-if="section" class="py-3 wallets">
            ...
            <div class="row no-gutters align-items-center">
              ...
              <div class="col-3 cent" style="font:12px 'arial'">{{section.amount}}</div>
              <div class="col-3 cent" style="font:12px 'arial'">{{section.hash}}</div>
...
export default {
  ...
  methods: {
    async getc () {
      await axios
        .get('adminpanel/cp_depositreject')
        .then(response => {
