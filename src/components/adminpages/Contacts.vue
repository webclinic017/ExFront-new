  ...
  <div>
    ...
    <div class="d-flex flex-wrap justify-content-between ui-bordered px-3 pt-3 mb-4">
      <div>
        ...
        <b-btn variant="outline-dark" class="col-12 ml-3"><span class="ion ion-md-add"></span>&nbsp; Add contact</b-btn>
      </div>
      <b-input class="col-12" placeholder="Search..." style="max-width: 200px;" />
    </div>
