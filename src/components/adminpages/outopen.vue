        ...
        <div v-for="section in requestsbuy" :key="section.title">
          <b-card-body class="py-3 wallets">
            ...
            <div class="row no-gutters align-items-center">
              <div v-if="String(section.act) === '0'" style="colorString:yellow" class="col-2 cent alert alert-secondary">{{String(section.act).replace('0','در حال پیگیری').replace('2','انجام شده').replace('1','رد شده')}}</div>
