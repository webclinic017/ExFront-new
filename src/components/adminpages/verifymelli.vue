  ...
  <div>
      ...
      <b-card no-body class="col-12 d-none d-md-block">
        ...
        <b-card-header class="row no-gutters align-items-center">
          <div class="col-1 cent">نام کاربر</div>
          ...
          <b-card-body class="py-3 wallets">
            ...
            <div class="row no-gutters align-items-center">
              ...
              <div class="col-5 cent"><a href="javascript:void(0)" class="text-big font-weight-semibold">
                  ...
                  <div class="col-3 left"><button class="btnfont btn btn-danger" @click="reject(section.get_user_id , section.id)">رد درخواست</button><button class="btnfont btn btn-success" @click="accept(section.get_user_id , section.id)"> تایید درخواست</button></div>
            </div>
        ...
        <div v-for="section in requests" :key="section.title" class="">
          <b-card-body class="py-3 wallets ">
            ...
            <div style="width:45% ;float:right">
              ...
              <h4 style=" height:50px " >کد ملی : </h4>
            ...
            <div style="width:45% ;float:left">
              ...
              <h4 style=" height:50px ; text-align:left ">{{section.mellic}}</h4>
...
export default {
  ...
  methods: {
    ...
    async accept (user, id) {
      await axios
        .post('adminpanel/verifymelli', { user: user, id: id })
        .then(response => {
    ...
    async reject (user, id) {
      await axios
        .put('adminpanel/verifymelli', { user: user, id: id })
        .then(response => {
