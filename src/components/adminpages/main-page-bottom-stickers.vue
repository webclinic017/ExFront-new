      ...
      <b-card no-body class="col-12">
        ...
        <b-card-header class="row no-gutters align-items-center">
         ...
         <div v-for="(section , idx) in pages" :key="idx">
          ...
          <b-card-body v-if="!pages" class="py-3 wallets">
      ...
      <b-card id="form" no-body class="col-12">
          ...
          <b-card-body class="py-3 wallets">
            <form @submit.prevent="submit()" enctype="multipart/form-data">
              <input  maxlength='30' type="text" v-model="title" class="form-control" placeholder="تیتر"><br>
              <b-textarea maxlength='250' v-model="minitext" placeholder="خلاصه پیام" rows="8"></b-textarea><br>
...
export default {
  ...
  methods: {
    ...
    async submit () {
      ...
      await axios
        .put(`adminpanel/bottomsticker` , formdata)
        .then(response => {
          setTimeout(() => {
            this.getp()
          }, 2000)
      ...
      await axios
        .post(`adminpanel/bottomsticker` , formdata)
        .then(response => {
          setTimeout(() => {
            this.getp()
          }, 200)
